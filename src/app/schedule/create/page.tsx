...
function CreateScheduleContent() {
  ...
  if (!selectedAnimalId) {
    return (
      <FarmLayout
        title="เลือกสัตว์"
        subtitle="เลือกสัตว์ที่ต้องการสร้างกำหนดการ"
        farmId={farmId}
      >
        <motion.div
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-base-content/70">
              เลือกสัตว์ที่ต้องการสร้างกำหนดการ
            </p>
          </div>
  ...
  return (
    <FarmLayout
      title="กำหนดกิจกรรม"
      subtitle="กำหนดการกิจกรรมในอนาคตสำหรับสัตว์"
      farmId={farmId}
    >
      <motion.div
        initial={{ opacity: 0, y: 20 }}
      ...
      >
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <h1 className="text-2xl font-bold">กำหนดกิจกรรม</h1>
          </div>
          <p className="text-base-content/70">
            กำหนดการกิจกรรมในอนาคตสำหรับสัตว์
          </p>
        </div>
